  ...
  return (
    <div className="w-full relative mt-[150px]">
      <div className="mb-[40px]">
        <h1 className="font-bold  text-[35px] mb-12 w-full text-center dark:text-white text-black">My Skills & <span className="text-blueColor">Abilities</span></h1>
      </div>

      <div className="flex flex-wrap w-full justify-start">
        {skills.map((skill, index) => (
          <div className="w-1/2 pl-0 p-7 md:w-[33.33%]" key={index}>
            <div className="flex items-center flex-col">
              ...
              <h1 className="text-sm flex items-center uppercase font-semibold text-center">{skill.title}</h1>
            </div>
          </div>
        ))}
      </div>
