        ...
        <section className="w-full pt-8">
            <div className="w-full relative flex flex-wrap md:gap-0 gap-5">
                <div className="lg:w-[33.33%] md:w-1/2 lg:pl-0 md:p-[15px] w-full">
                    <div className="w-full mx-0 relative dark:shadow-new border dark:border-white/[0.09] border-black/[0.09] dark:bg-black bg-lightBlue pt-[30px] px-[25px] pb-[30px] transition-all duration-300 ease-in-out rounded-lg flex items-center">
                        ...
                        <div className="block flex-1 ml-8">
                            <h1 className='text-blueColor font-medium text-[34px] leading-[40px]'><AnimatedNumbers value={achievements[0].value} /> +</h1>
                            <Link href={"tel:0748567120"} target='_blank' className='text-black dark:text-white text-xs font-semibold uppercase'>{achievements[0].title}</Link>
                        </div>
                    </div>
                </div>
                <div className="lg:w-[33.33%] md:p-[15px] md:w-1/2 w-full">
                    <div className="w-full mx-0 relative dark:shadow-new border dark:border-white/[0.09] border-black/[0.09] dark:bg-black bg-lightBlue pt-[30px] px-[25px] pb-[30px] transition-all duration-300 ease-in-out rounded-lg flex items-center">
                        ...
                        <div className="block flex-1 ml-8">
                            <h1 className='text-blueColor font-medium text-[34px] leading-[40px]'><AnimatedNumbers value={achievements[1].value} /> +</h1>
                            <Link href={"tel:0748567120"} target='_blank' className='text-black dark:text-white text-xs font-semibold uppercase'>{achievements[1].title}</Link>
                        </div>
                    </div>
                </div>
                <div className="lg:w-[33.33%] md:p-[15px] lg:pr-0 md:w-1/2 w-full">
                    <div className="w-full mx-0 relative dark:shadow-new border dark:border-white/[0.09] border-black/[0.09] dark:bg-black bg-lightBlue pt-[30px] px-[25px] pb-[30px] transition-all duration-300 ease-in-out rounded-lg flex items-center">
                        ...
                        <div className="block flex-1 ml-8">
                            ...
                            <Link href={"tel:0748567120"} target='_blank' className='text-black dark:text-white text-xs font-semibold uppercase'>{achievements[2].title}</Link>
                        </div>
                    </div>
                </div>
            </div>
